     ...
     <a class="project-link" href="{{route('admin.projects.show', $project)}}">
         <div class="project-card mb-4  d-flex">
             <div class="type">
                 ...
                 @elseif(strpos($project->type?->type, 'Vite') !== false)
